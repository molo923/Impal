<div id="content">
  <div id="content-header">
    ...
    <h1>Edit Kategori Sampah</h1>
            ...
            <form action="<?php echo base_url()?>C_Katsampah/editkategori/<?php echo $kat['id_kategorisampah']?>/<?php echo $kat['kode_kat']?>" method="POST" class="form-horizontal">
            <div class="control-group">
              <label class="control-label">Id Kategori Sampah :</label>
              <div class="controls">
                <input type="text" class="span3" placeholder="Id Kategori Sampah" name="kode_kat" value="<?php echo $kat['kode_kat']?>" />
              </div>
            </div>
