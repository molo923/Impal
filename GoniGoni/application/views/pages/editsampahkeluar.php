    ...
    <hr>
        <div class="widget-box">
          ...
          <form action="<?php echo base_url()?>C_Sampahkeluar/editsampahkeluars/<?php echo $data[0]['id_sampahkeluar'];?>" method="POST" class="form-horizontal">
           ...
           <div class="control-group">
              ...
              <div class="controls">
                <input type="number" class="span3" placeholder="Berat Sampah /Kg" name="berat[]" value="<?php echo $data[0]['berat']?>" step='0.01' required/>
              </div>
              <label class="control-label">Berat Reject :</label>
              <div class="controls">
                <input type="number" class="span3" placeholder="Berat Sampah Reject /Kg" name="berat_reject[]" value="<?php echo $data[0]['berat_reject']?>" step='0.01' required />
              </div>
            </div>
          ...
          <div class="control-group">
              ...
              <div class="controls">
                <input type="number" class="span3" placeholder="Harga/Kg" name="harga[]" value="<?php echo $data[0]['harga_kg']?>" step='0.01' required />
              </div>
            </div>
          ...
          <div class="control-group">
              ...
              <div class="controls">
                <select name="status_terima[]">
                  ...
                  <option value="reject" <?php if ($data[0]['status_terima'] == 'reject') {
                    # code...
                    echo "selected";
                  }?>>Reject</option>
                </select>
          ...
          for ($i=1; $i <= count($data)-1 ; $i++) { ?>
           ...
           <div class="control-group">
              <label class="control-label">Berat :</label>
              <div class="controls">
                <input type="number" class="span3" placeholder="Berat Sampah /Kg" name="berat[]" value="<?php echo $data[$i]['berat']?>" step='0.01' required/>
              </div>
              <label class="control-label">Berat Reject :</label>
              <div class="controls">
                <input type="number" class="span3" placeholder="Berat Sampah Reject /Kg" name="berat_reject[]" value="<?php echo $data[$i]['berat_reject']?>" step='0.01' required/>
              </div>
            </div>
          ...
          <div class="control-group">
              <label class="control-label">Harga/Kg :</label>
              <div class="controls">
                <input type="number" class="span3" placeholder="Harga/Kg" name="harga[]" value="<?php echo $data[$i]['harga_kg']?>" step='0.01' required/>
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <select name="status_terima[]">
                  ...
                  <option value="reject" <?php if ($data[$i]['status_terima'] == 'reject') {
                    # code...
                    echo "selected";
                  }?>>Reject</option>
                </select>
        ...
        <?php } }?>
           ...
           <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span3" placeholder="Tujuan Sampah Keluar" name="tujuan_sampahkeluar" value="<?php echo $data[0]['tujuan_sampahkeluar']?>" required />
              </div>
            </div>
          ...
          <div class="control-group">
              ...
              <div class="controls">
                <input type="number" class="span3" placeholder="Biaya Sampah Keluar" name="biaya_sampahkeluar" value="<?php echo $data[0]['biaya_sampahkeluar']?>" step='0.01' />
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="date" class="span3" placeholder="Id Kategori Sampah" name="tgl_sampahkeluar" value="<?php echo $data[0]['tgl_sampahkeluar'];?>" />
              </div>
            </div>
            ...
            <div class="control-group" >
              ...
              <div class="controls">
                <select name="status_sampahkeluar">
                  ...
                  <option value="reject" <?php if ($data[0]['status_sampahkeluar'] == 'reject') {
                    # code...
                    echo "selected";
                  }?>>Reject</option>
                </select>
...
$(document).ready(function(){
    ...
    $(".addMore").click(function(){
           ...
           <div class="control-group">
              ...
              <label class="control-label">Berat Reject :</label>
              <div class="controls">
                <input type="number" class="span3" placeholder="Berat Sampah Reject /Kg" name="berat_reject[]" value='0' required/>
              </div>
            </div>
