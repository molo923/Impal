<div id="content">
  ...
  <div class="container-fluid">
    <hr>
    <form method="POST" action="<?=base_url()?>C_Stoking/histori_sampah">
      <div class="control-group">
        ...
        <div class="widget-box">
          <div class="widget-title"> 
            <span class="pull-right"><a href="<?=base_url();?>C_Stoking" class="btn btn-primary">Stok Saat Ini</a> </span>
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>      
                    <center>
                      <form method="POST" action="<?=base_url();?>C_Stoking/detailstok/<?=$st['id_kategorisampah']?>">
                        <input type="hidden" name="periode" value="<?=$periode;?>">
                        <input type="submit" name="detail" value="Detail" class="btn btn-info">
                      </form>
                    </center>
                  </td>
                  </tr>
