<div id="content">
  <div id="content-header">
    ...
    <h1>Tambah Nasabah</h1>
            ...
            <form action="<?php echo base_url()?>C_Nasabah/insertnasabah" method="POST" class="form-horizontal">
            <div class="control-group">
              <label class="control-label">Nama Nasabah :</label>
              <div class="controls">
                <div class="span3">
                <input type="text" placeholder="Nama Nasabah" name="nama_nasabah" />
              </div>
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <div class="span3">
                <input type="text" placeholder="Nomor Nasabah" name="nohp_nasabah" />
              </div>
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <div class="span3">
                <input type="text" placeholder="Email Nasabah" name="email_nasabah" />
              </div>
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <div class="span3">
                <textarea  name="alamat_nasabah" ></textarea>
              </div>
            </div>  
            </div>
