    ...
    <h1>Table Kategori Sampah</h1>
     ...
     <?php if($this->session->flashdata('inkatfail')){ ?>
           ...
           <div class="alert alert-error">
              ...
              <strong>Gagal Menambahkan!</strong> Kode Kategori Sampah Sudah Ada</div>
        </div>      <?php } ?> 
         ...
         <?php if($this->session->flashdata('inkatup')){ ?>
                <div class="widget-box">
           <div class="alert alert-success">
              <button class="close" data-dismiss="alert">×</button>
              <strong>Berhasil !</strong> <?=$this->session->flashdata('inkatup')?></div>
        </div>      <?php } ?> 
        ...
        <div class="widget-box">
          <div class="widget-title"> 
            ...
            <div class="control-group">
              <label class="control-label">Kode Kategori Sampah :</label>
              <div class="controls">
                <input type="text" class="span3" placeholder="Kode Kategori Sampah" name="kode_kat" required />
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="number" step="0.01" class="span3" placeholder="Harga Sampah /Kg" name="harga" required />
              </div>
            </div>
            <div class="control-group">
                  ...
                  <tr>
                    ...
                    <td><?php echo $k['deskripsi_kat'];?></td>
                     <td><center><a href="<?php echo base_url()?>C_Katsampah/editkatform/<?php echo $k['id_kategorisampah'];?>"><button class="btn btn-warning">edit</button></a>
                      <?php if ($k['status_kat'] == 'aktif') {
                       $stat = 'nonaktifkan';
                       } else{ $stat = 'aktifkan';}?>
                     <a href="<?php echo base_url();?>C_Katsampah/updatestat?id=<?=$k['id_kategorisampah'];?>&stat=<?=$stat;?>"><button class="btn btn-danger"><?php echo $stat;?></button></a>
                    </center></td>
                  </tr>
                <?php  }
                    }
