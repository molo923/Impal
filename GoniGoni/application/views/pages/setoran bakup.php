    ...
    <hr>
            ...
            <table class="table table-bordered data-table">
              <thead>
                <tr>
                  ...
                  <th>Total Berat Reject</th>
                  <th>Total Berat Residu</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo $s['totalb_reject']; ?> Kg</td>
                  <td><?php echo $s['totalb_residu']; ?> Kg</td>
     ...
     <!--                <a href="#myAlert" data-toggle="modal"  class="btn btn-primary" id="detail" value='a'>Detail</a> -->
                    <center>
                      ...
                      <a href="<?php echo base_url()?>C_Setoran/editsetoranform/<?php echo $s['id_setoran']?>" class="btn btn-warning">Kelola</a>
                    </center>
                  </td>
                  </tr>
              <?php } ?>
        ...
        $('button').click(function(){
            ...
            //  $('.detailer').html(httt);
                ...
                <tr class="odd gradeX">
                  ...
                  <td>`+obj[i].beratsetoran_reject+` Kg</td>
                  <td>`+obj[i].berat_residu+` Kg</td>
