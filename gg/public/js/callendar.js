...
/* harmony import */ var _fullcalendar_core_locales_id__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @fullcalendar/core/locales/id */ "./node_modules/@fullcalendar/core/locales/id.js");
/* harmony import */ var _fullcalendar_core_locales_id__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_fullcalendar_core_locales_id__WEBPACK_IMPORTED_MODULE_5__);
...
function yoman() {
  var input = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : moment();
  var weekOfYear = input.weeks();
  var weekOfYearNextMonth = input.add(1, "month").startOf("month").weeks();
...
function getISOWeekInMonth(date) {
  ...
  var d = new Date(+date);
  if (isNaN(d)) return; // Move to previous Monday

  d.setDate(d.getDate() - d.getDay() + 1); // Week number is ceil date/7
...
var CalendarApp = function CalendarApp() {
  this.$body = $("body");
  this.$calendar = document.getElementById("calendar"), this.$event = '#calendar-events div.calendar-events', this.$modal = $('#my-event'), this.$calendarObj = null;
};

CalendarApp.prototype.onSelect = function (info) {
  console.log("test");
}, CalendarApp.prototype.onDateClick = function (info, self) {
  var events = self.$calendarObj.getEvents().filter(function (event) {
    return moment(event.extendedProps.tglMulai).format("YYYY-MM-DD") <= moment(event.start).format("YYYY-MM-DD") && moment(event.start).format("YYYY-MM-DD") === moment(info.date).format("YYYY-MM-DD") && event.extendedProps.weeks && event.extendedProps.weeks.includes(weekOfMonth(moment(info.date)).toString()) || event.extendedProps.tglJemput && moment(event.extendedProps.tglJemput).format("YYYY-MM-DD") === moment(info.date).format("YYYY-MM-DD");
  });
  ...
  if (events.length !== 0) {
    ...
    $.each(events, function (index, item) {
      var checkJemput = !item.extendedProps.tglJemput ? 'd-none' : '';
      var detailJemput = "\n                    <p class=\"mb-2\">Tanggal Jemput: ".concat(moment(item.extendedProps.tglJemput).format('dddd, D MMMM YYYY'), "</p>\n                    <p class=\"mb-2\">Armada: ").concat(item.extendedProps.armada, "</p>\n                    <p class=\"mb-2\">Driver: ").concat(item.extendedProps.driver, "</p>\n                    <p class=\"m-0\">Status: ").concat(item.extendedProps.status, "</p>\n                ");
      modal.find('.modal-body').append("\n                        <div class=\"card border\">\n                            <div class=\"card-body\">\n                                <p class=\"mb-2\">Nama Nasabah: ".concat(item.title, "</p>\n                                <p class=\"mb-2\">Alamat: ").concat(item.extendedProps.alamat, "</p>\n                                <p class=\"mb-0\">No Telepon: ").concat(item.extendedProps.no_telp, "</p>\n                                <div class=\"accordion mt-4 ").concat(checkJemput, "\" id=\"accordionJemput").concat(item.id, "\">\n                                    <a href=\"#\" id=\"accHeading\" data-toggle=\"collapse\" data-target=\"#collapseJemput").concat(item.id, "\">Detail Jemput</a>\n                                    <div id=\"collapseJemput").concat(item.id, "\" class=\"collapse mt-2\">\n                                        ").concat(detailJemput, "\n                                    </div>\n                                </div>\n                            </div>\n                        </div>\n                    "));
    }); // let locs = [];
    //
...
CalendarApp.prototype.init = function (data) {
  ...
  data.jemput_data.forEach(function (item, index) {
    ...
    defaultEvents.push(_objectSpread({
      id: item.id,
  ...
  var $this = this;
  $this.$calendarObj = new _fullcalendar_core__WEBPACK_IMPORTED_MODULE_0__["Calendar"](this.$calendar, {
    locale: _fullcalendar_core_locales_id__WEBPACK_IMPORTED_MODULE_5___default.a,
    plugins: [_fullcalendar_bootstrap__WEBPACK_IMPORTED_MODULE_3__["default"], _fullcalendar_daygrid__WEBPACK_IMPORTED_MODULE_1__["default"], _fullcalendar_list__WEBPACK_IMPORTED_MODULE_4__["default"], _fullcalendar_interaction__WEBPACK_IMPORTED_MODULE_2__["default"]],
    ...
    views: {
      ...
      listDay: {
        buttonText: 'list harian'
      },
      listWeek: {
        buttonText: 'list mingguan'
      }
    },
...
/***/ 1:
/*!*****************************************!*\
  !*** multi ./resources/js/callendar.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /mnt/c/Users/habilds/code/php/gg_banksampah/resources/js/callendar.js */"./resources/js/callendar.js");
